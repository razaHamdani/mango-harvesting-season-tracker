...
-- ============================================================
-- Storage: aam-daata-photos bucket + RLS policies
-- Private bucket. Each user can read/write/delete only within
-- their own UID-prefixed folder.
-- ============================================================

INSERT INTO storage.buckets (id, name, public)
VALUES ('aam-daata-photos', 'aam-daata-photos', false)
